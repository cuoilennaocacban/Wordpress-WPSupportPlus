...
function getDependencyField() {
	jQuery('#settingsDependencyFields .wait').show();
	jQuery('#settingsDependencyFields .settingsDependencyFieldsContainer').hide();

	var data = {
		'action': 'getDependencyField'
	};

	jQuery.post(display_ticket_data.wpsp_ajax_url, data, function (response) {
		jQuery('#settingsDependencyFields .wait').hide();
		jQuery('#settingsDependencyFields .settingsDependencyFieldsContainer').html(response);
		jQuery('#settingsDependencyFields .settingsDependencyFieldsContainer').show();
	});
}
